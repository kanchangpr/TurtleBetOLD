...
public class QueryListConstant {
	...
	public static final String UPDATE_AVAIL_BAL_AND_PROFIT_LOSS="UPDATE JETBET.JB_USER_DETAILS SET AVAIL_BALANCE=? , PROFIT_LOSS=? , LASTUPDATEDDATE=CURRENT_TIMESTAMP, LASTUPDATEBY='TURTLE_BETS' WHERE USER_ID= ?";
