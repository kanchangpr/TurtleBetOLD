...
public class QueryListConstant {
	...
	public static final String UPDATE_BET_RESULT="UPDATE JETBET.JB_BET_DETAILS SET BET_STATUS = ? , LAST_UPDATED_DATE=CURRENT_TIMESTAMP , LAST_UPDATED_BY='TURTLE_BETS' WHERE SELECTION_ID=? AND MARKET_ID=? AND BET_STATUS='ACTIVE'";
