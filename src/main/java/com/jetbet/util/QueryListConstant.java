...
public class QueryListConstant {
	...
	public static final String UPDATE_BET_RESULT="UPDATE JETBET.JB_BET_DETAILS T SET BET_RESULT = (CASE WHEN ISBACK = 'Y' AND ISLAY ='N' AND BET_STATUS = 'WINNER' THEN 'WON' WHEN ISBACK = 'Y' AND ISLAY ='N' AND BET_STATUS = 'LOSER' THEN 'LOST' WHEN ISBACK = 'N' AND ISLAY ='Y' AND BET_STATUS = 'LOSER' THEN 'WON' WHEN ISBACK = 'Y' AND ISLAY ='N' AND BET_STATUS = 'WINNER' THEN 'LOST' WHEN BET_STATUS ='REMOVED' THEN 'REMOVED'  ELSE BET_RESULT END) WHERE BET_RESULT NOT IN ('WON','LOST') AND BET_STATUS <> 'ACTIVE'";
