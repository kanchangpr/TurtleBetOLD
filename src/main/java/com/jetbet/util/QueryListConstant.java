...
public class QueryListConstant {
	...
	public static final String UPDATE_PARENT_PROFIT_LOSS="UPDATE JETBET.JB_BET_DETAILS SET NET_AMOUNT=NET_AMOUNT+?, MASTER_STAKES= MASTER_STAKES+?, SM_STAKES=SM_STAKES+?, ADMIN_STAKES=ADMIN_STAKES+? , LAST_UPDATED_BY='TURTLE_BETS', LAST_UPDATED_DATE=CURRENT_TIMESTAMP WHERE USER_ID= ? AND BET_SETTLEMENT='PENDING'";
